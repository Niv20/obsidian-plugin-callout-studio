...
2. Review the **Callout ID**. It fills automatically from the display name and is the token you type in your notes. Add more IDs if you want aliases for the same callout.
