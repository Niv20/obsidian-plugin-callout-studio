export const nb: Record<string, string> = {
	...
	"deleteModal.titleKeep": 'Fjerne all bruk av "{{name}}"?',
	"deleteModal.keepsRowBuiltIn":
		"Dette er en av Obsidians innebygde callouts, så selve typen forblir tilgjengelig — bare bruken i notatene dine endres.",
	"deleteModal.keepsRowTheme":
		"{{theme}} definerer denne callout-typen, så den forblir tilgjengelig og beholder utseendet sitt. Callout Studio endrer bare notater inne i valvet ditt — ingenting som tilhører temaet ditt blir rørt.",
	"deleteModal.clearUsages": "Fjern bruk (konverter til ren tekst)",
	...
	"settings.themeCalloutsHeading": "Callouts fra temaet ditt",
	"settings.themeCalloutsDesc":
		"{{theme}} leverer eller omstiler disse, så Callout Studio lar dem være akkurat som temaet ditt tegner dem, og tilbyr dem kun som blokk-callouts. Begge typer vises her: callout-typer temaet ditt legger til, og innebygde callouts hvis utseende det erstatter. Callout-typer temaet ditt legger til, vises bare mens det er aktivt.",
	"settings.themeCalloutsDefaultTheme": "Temaet ditt",
	"settings.themePreviewAria":
		'Forhåndsvis "{{name}}" — se hvordan temaet ditt tegner den',
	"settings.clearUsesAction": "Fjern bruk i notatene dine",
	"settings.builtInAllThemeStyled":
		"{{theme}} omstiler alle innebygde callouts, så de er alle listet ovenfor, og Callout Studio lar dem være. For å designe din egen, legg til en callout med en annen ID.",
	...
	"settings.editPaletteAria": "Rediger palett {{name}}",
	...
	"commandBuilder.roleThemeOwned":
		"Temaet ditt leverer denne callouten, så den har bare et blokkformat.",
	"commandBuilder.commandSuspended":
		"Satt på pause: temaet ditt leverer denne callouten, så den har bare et blokkformat. Denne kommandoen fungerer igjen når temaet slutter å levere den.",
	...
	"notice.importedCalloutManager":
		"Importert fra Callout Manager: {{created}} opprettet, {{updated}} oppdatert.",
	"notice.importedAdmonition":
		"Importert fra Admonition: {{created}} opprettet, {{updated}} " +
		"oppdatert.",
	"notice.noNewJSON":
	...
	"editor.idCannotDelete":
		"Denne ID-en er koblet til visningsnavnet og kan ikke slettes — rediger navnet for å endre den",
	"editor.icon": "Ikon",
	"editor.pickIcon": "Bytt ikon",
	"editor.replaceIcon": "Erstatt ikon",
	"editor.removeIcon": "Fjern ikon",
	"editor.noIcon": "Ikke noe ikon",
	"editor.resetIcon": "Tilbakestill ikon til standard",
	"editor.livePreview": "Live-forhåndsvisning",
	"editor.iconAdjustment": "Ikontilpasning",
	"editor.picture": "Bilde",
	...
	"editor.idFromTheme":
		"{{theme}} tilbyr allerede en callout med denne ID-en, så Callout Studio kan ikke stile den. Velg en annen ID.",
	...
	"editor.themePreviewClose": "Forstått",
	...
	"palette.accentColor": "Aksentfarge",
	"palette.backgroundColorChannel": "Bakgrunnsfarge",
	"palette.textColorChannel": "Tekstfarge",
	...
	"colorName.white": "Hvit",
	"colorName.crimson": "Karmosinrød",
	"colorName.coral": "Korall",
	"colorName.grape": "Drue",
	"colorName.plum": "Plomme",
	...
	"iconPicker.descLucide": "Obsidians eget sett, alltid frakoblet",
	"iconPicker.descTabler": "rene og konsistente UI-ikoner, kontur og fylt",
	"iconPicker.descMaterial": "Googles sett, fire stiler og syv tykkelser",
	"iconPicker.descEmoji": "fargerike glyfer, alle hudtoner",
	...
	"portable.restoreDefault": "Gjenopprett standarderstatning",
	"portable.customTitle": "Egendefinert erstatning",
	"portable.customSave": "Lagre erstatning",
	"portable.customInvalid": "Hold erstatningen på én linje uten å endre Markdown-strukturen rundt den.",
	"portable.customUnsafe": "Denne erstatningen ville gjøre en overskrift eller lenkene til den tvetydige. Velg en annen overskrift.",
	"portable.customStale": "Gjennomgangen er endret. Lukk dette vinduet og åpne erstatningsredigereren igjen.",
	"portable.customDiscarded": "{{count}} egendefinerte erstatninger ble fjernet fordi kildeteksten deres ble endret eller ikke kunne finnes med sikkerhet.",
	"portable.customBadge": "Egendefinert",

	"usage.title": "Forekomster av Callout Studio",
	...
	"usage.partial": "Resultatene er ufullstendige: {{count}} lesefeil.",
	"usage.stale": "Oppdaterer callout-forekomster…",
	"usage.empty": "Fant ingen samsvarende callouter.",
	"usage.failedFiles": "Filer som ikke kunne leses",
	"usage.vaultReadFailed": "Kunne ikke hente listen over Markdown-notater i denne vaulten.",
	"usage.more": "Vis {{count}} til",
	...
	"import.err.idMetadata":
		'ID-en "{{value}}" inneholder et "|". I Obsidian er alt etter det første "|" callout-metadata, ikke en del av typen, så denne oppføringen beskriver callouten "{{id}}". Hoppet over, slik at ditt eksisterende "{{id}}" forblir uendret.',
	"import.err.idReserved":
		'ID-en "{{value}}" er reservert av Callout Studio for dens egne forhåndsvisninger og kan ikke importeres.',
	...
	"import.warn.unknownFields": "Ukjente felt ignorert: {{fields}}.",
	...
	"import.err.paletteIdInvalid":
		'"paletteId" må være en ikke-tom tekst-ID (mottok "{{value}}").',
	...
	"import.admInstructions":
		...
		"farge. Innstillinger uten en motsvarighet i Callout Studio " +
		"(kommando, kopiknapp, skjult tittel) blir igjen.",
	...
	"import.err.admNotRecognized":
		"Ukjent fil: forventet en liste med admonitions eller en " +
		"data.json fra Admonition.",
	"import.err.admNoEntries": "Fant ingen admonitions å importere.",
	...
	"import.warn.admIconWithCss":
		...
		"navn, ikon og farge ble med.",
	"import.warn.admNoColor":
		"Ingen farge var angitt, så standardblåfargen ble brukt.",
	"import.warn.admTitleTruncated":
		"Tittelen er på {{length}} tegn; den ble forkortet til {{max}}.",

	"footer.prompt":
		"Spørsmål, feil eller ideer? Jeg vil gjerne høre fra deg!{{break}} {{issue}} eller {{email}}.",
	"footer.openIssue": "Åpne en GitHub-issue",
	"footer.sendEmail": "send meg en e-post",
	...
	"palette.colorExistsUse":
		'Disse fargene er identiske med "{{name}}". To lagrede farger kan ikke være like — endre en farge, eller {{link}}.',
	...
	"export.formatCssDesc":
		"For nettsteder eller vaulter der Callout Studio ikke kjører. Omfatter bare blokk-callouts og må eksporteres på nytt etter endringer.",
	"quickInsert.readingViewHint": "Dette notatet er åpent i lesemodus, så ingenting kan settes inn.",
	...
	"saveStatus.writeSpace": "Innstillingsfilen kunne ikke lagres fordi lagringsplassen er full eller kvoten er overskredet. Frigjør litt plass, og prøv igjen.",
	"settings.readOnly": "Callout Studio kunne ikke bruke innstillingsfilen sin da Obsidian startet, så ingenting på denne siden lagres på denne enheten. Endringene dine varer til du lukker Obsidian. Last inn Obsidian på nytt så snart filen er tilbake — hvis du synkroniserer dette hvelvet, la synkroniseringen bli ferdig først.",
	"portable.headingsTable": "Overskrifter",
	"portable.inlineTable": "Innebygd",
	"portable.reviewTitle": "Callout Studio-konvertering",
	"portable.roleLink": "Overskriftslenke",
	"portable.convertSelected": "Konverter valgte…",
	"portable.selectionSummary": "{{selected}} av {{total}} erstatninger valgt · {{links}} overskriftslenker skal oppdateres",
	...
	"portable.openFailed": "Kunne ikke åpne sidepanelet for konvertering.",
	"portable.closeSettings": "Lukk innstillingene for å gjennomgå konverteringen i sidepanelet.",
	"portable.retry": "Prøv igjen",
	"portable.blockedAmbiguous": "Denne overskriften hoppes over fordi lenkemålet er tvetydig.",
	"portable.blockedTarget": "Denne overskriften hoppes over fordi lenkemålet ikke kan bevares trygt.",
	"portable.recovery": "Noen endringer gjenstår. Fullfør denne konverteringen og oppdateringen av overskriftslenker før du starter programtillegget på nytt eller deaktiverer det. Den ventende planen lagres bare i minnet.",
	"portable.recoveryChanged": "Notatene ble endret etter at konverteringen stoppet. Ventende lenkeoppdateringer beholdes, og hvert notat kontrolleres på nytt før skriving.",
	"portable.finishConversion": "Fullfør konvertering…",
	"portable.recoveryUnavailable": "Noen ventende lenkeoppdateringer kunne ikke gjenopprettes trygt. Kontroller de berørte notatene før du starter en ny konvertering.",
	"portable.title": "Konverter til standard Markdown",
	"portable.settingDesc": "Erstatt callouts i overskrifter og løpende tekst i hele hvelvet med vanlig tekst som kan brukes uten Callout Studio.",
	"portable.review": "Gjennomgå konvertering",
	"portable.intro": "Hvis du vil slutte å bruke Callout Studio eller flytte hvelvet til en app som ikke støtter det, kan du konvertere callouts i overskrifter og løpende tekst til standard Markdown.",
	"portable.before": "Før",
	"portable.after": "Etter",
	"portable.word": "Ord",
	"portable.type": "type",
	"portable.text": "Tekst",
	"portable.headingText": "Tittel",
	...
	"portable.convert": "Konverter hvelv…",
	...
	"portable.converting": "Konverterer de valgte endringene… Konverteringen fortsetter selv om du lukker dette panelet.",
	"portable.complete": "Konverterte {{count}} forekomster og oppdaterte {{links}} overskriftslenker i {{files}} notater.",
	"portable.stopped": "Konverteringen stoppet. {{count}} forekomster og {{links}} overskriftslenker i {{files}} notater er allerede endret. Disse endringene beholdes.",
	"portable.errorEditor": "Lagre åpne notater for å oppdatere gjennomgangen automatisk.",
