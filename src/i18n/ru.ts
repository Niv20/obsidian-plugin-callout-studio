export const ru: Record<string, string> = {
	...
	"usage.markdownFiles": "Файлы Markdown",
	"usage.filterRole": "Фильтр по формату",
	...
	"usage.menuCount": "Найти использования: {{count}} в {{files}} файлах",
