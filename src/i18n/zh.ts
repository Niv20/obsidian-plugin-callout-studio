export const zh: Record<string, string> = {
	"portable.headingsTable": "标题",
	"portable.inlineTable": "行内",
	"portable.reviewTitle": "Callout Studio 转换",
	"portable.roleLink": "标题链接",
	"portable.convertSelected": "转换所选内容…",
	"portable.selectionSummary": "已选择 {{selected}} / {{total}} 项替换 · {{links}} 个标题链接需要更新",
	...
	"portable.openFailed": "无法打开转换侧边栏。",
	"portable.closeSettings": "请关闭设置，在侧边栏中检查转换内容。",
	"portable.retry": "重试",
	"portable.blockedAmbiguous": "此标题的链接目标不明确，因此已跳过。",
	"portable.blockedTarget": "无法安全保留此标题的链接目标，因此已跳过。",
	"portable.recovery": "仍有更改待处理。请在重启或禁用插件前完成本次转换及标题链接更新；待处理计划仅保存在内存中。",
	"portable.recoveryChanged": "转换停止后，笔记发生了更改。待更新的链接已保留；写入前会重新检查每篇笔记。",
	"portable.finishConversion": "完成转换…",
	"portable.recoveryUnavailable": "无法安全恢复部分待处理的链接更新。请先检查受影响的笔记，再开始新的转换。",
	"portable.title": "转换为标准 Markdown",
	"portable.settingDesc": "将整个仓库中的标题和行内 callout 替换为普通文本，方便在没有 Callout Studio 的环境中使用。",
	"portable.review": "检查转换内容",
	"portable.intro": "如果您打算停止使用 Callout Studio，或将仓库迁移到不支持它的应用，可以将标题和行内 callout 转换为标准 Markdown。",
	"portable.before": "转换前",
	"portable.after": "转换后",
	"portable.word": "文字",
	"portable.type": "类型",
	"portable.text": "文本",
	"portable.headingText": "标题",
	"portable.backup": "建议在转换前备份仓库。此操作会修改原始笔记，且无法在 Callout Studio 中撤销。",
	"portable.convert": "转换仓库…",
	...
	"portable.converting": "正在转换所选内容… 关闭此面板不会停止转换。",
	"portable.complete": "已转换 {{files}} 篇笔记中的 {{count}} 处内容，并更新 {{links}} 个标题链接。",
	"portable.stopped": "转换已停止。{{files}} 篇笔记中的 {{count}} 处内容和 {{links}} 个标题链接已更改；这些更改会保留。",
	"portable.errorEditor": "保存已打开的笔记，即可自动更新预览。",
	"portable.errorChanged": "笔记已更改。请在转换前检查更新后的内容。",
	"portable.errorBusy": "另一个转换正在进行。请等待其完成。",
	"portable.error": "无法安全读取或更新仓库。请检查文件访问权限后重试。",
	"settings.maintenance": "危险区域",
	...
	"portable.restoreDefault": "恢复默认替换",
	"portable.customTitle": "自定义替换",
	"portable.customSave": "保存替换",
	"portable.customInvalid": "请将替换内容保留在一行内，不要更改周围的 Markdown 结构。",
	"portable.customUnsafe": "此替换会导致标题或其链接的目标不明确。请选择其他标题。",
	"portable.customStale": "预览已更改。请关闭此窗口，然后重新打开替换编辑器。",
	"portable.customDiscarded": "已清除 {{count}} 个自定义替换，因为其源文本已更改或无法安全定位。",
	"portable.customBadge": "自定义",

	"usage.title": "Callout Studio 出现位置",
	...
	"confirm.titleRestoreSettings": "恢复这些设置",
	"confirm.titleCreateSettingsFile": "创建设置文件",
	"confirm.restoreDisplayedSettings": "这会将当前显示的 callout 类型和偏好设置保存到此设备上的设置文件，并恢复保存。任何可读取的本地恢复副本都会先进行备份。\n继续之前，请等待同步服务完成，并检查其他设备上是否有你想保留的更新设置。同步服务可能会将此恢复的文件发送到你的其他设备。\n保存前会再次检查文件。如果找到现有设置，将保留它们，恢复流程可能会要求你再次检查。",
	...
	"saveStatus.createSettingsFile": "创建设置文件",
	"saveStatus.checkAgain": "再次检查",
	"saveStatus.stillMissing": "设置文件仍然缺失。再次检查不会重新创建它。请等待同步完成，并让仓库可离线使用。如果文件已被删除，请恢复备份，或在此设备的 Callout Studio 设置中使用恢复操作来保存当前显示的设置。",
	"saveStatus.recoverInSettings": "要在此设备上恢复缺失的文件，请打开 Callout Studio 设置。关闭此编辑器前，请复制你想保留的所有未保存编辑；它们尚未保存。",
