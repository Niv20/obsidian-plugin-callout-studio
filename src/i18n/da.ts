export const da: Record<string, string> = {
	...
	"deleteModal.bodyInUse":
		"Denne callout optræder {{count}} gang(e) i {{files}} fil(er).",
	"deleteModal.bodyInUseExplain":
		"Sletning konverterer disse blokke til almindelig tekst — de mister stil og callout-overskrift.",
	"deleteModal.replaceHint":
		"Du kan erstatte den med en anden callout, som bevarer vault-indholdet som en stilet callout.",
	"deleteModal.bodyUnused":
		'"{{name}}" bruges ikke i nogen note, men er en brugerdefineret callout, du har oprettet. Sletning fjerner den fra denne liste.',
	...
	"notice.importedAdmonition":
		"Importeret fra Admonition: {{created}} oprettet, {{updated}} " +
		"opdateret.",
	"notice.noNewJSON":
	...
	"notice.externalCssRetired":
		"Muligheden for personlig CSS-styling er fjernet. Disse callouts bruger nu deres gemte Callout Studio-design, medmindre dit tema styler dem. Dine noter og personlige CSS-snippets blev ikke ændret.",
	...
	"notice.autocompleteAlwaysEnabled": "Autofuldførelse er nu en kernefunktion og er altid aktiveret.",
	"notice.openHotkeysFailed":
		"Kunne ikke åbne Obsidians genvejsindstillinger.",
	"notice.filterHotkeysFailed":
		"Obsidian-genveje åbnet, men Callout Studio-filtret kunne ikke anvendes.",
	...
	"editor.replaceIcon": "Erstat ikon",
	"editor.removeIcon": "Fjern ikon",
	"editor.noIcon": "Intet ikon",
	...
	"editor.foldableDesc":
		"Vælg om callout'en kan foldes, og hvilken standardtilstand der skal anvendes i hele vault.",
	"editor.foldOff": "Fra",
	...
	"palette.advancedColors": "Farver",
	"palette.advancedColorsHint":
		"Redigerer farver for {{mode}}-tilstand – den anden tilstand opdateres automatisk. Skift Obsidians tema for at tjekke det.",
	"palette.revertHint":
		"Foretrækker du en enkelt basisfarve i stedet? {{link}}.",
	"palette.revertHintLink": "Fortryd",
	"palette.lightMode": "Lys",
	"palette.darkMode": "Mørk",
	"palette.accentColor": "Accentfarve",
	"palette.backgroundColorChannel": "Baggrundsfarve",
	"palette.textColorChannel": "Tekstfarve",
	"palette.bgIntensity": "Intensitet",
	"palette.bgStyle": "Stil",
	"palette.bgSolid": "Ensfarvet",
	"palette.bgGradient": "Gradient",
	"palette.bgTransparent": "Gennemsigtig",
	...
	"iconPicker.searchTabler": "søg Tabler-ikoner",
	"iconPicker.tablerStyle": "Ikonstil",
	"iconPicker.tablerStyleOutline": "Kontur (Outline)",
	"iconPicker.tablerStyleFilled": "Fyldt (Filled)",
	"iconPicker.loadMore": "Indlæs flere",
	"iconPicker.materialStyle": "Ikonstil",
	"iconPicker.materialStyleOutlined": "Kontur (Outlined)",
	"iconPicker.materialStyleFilled": "Fyldt (Filled)",
	"iconPicker.materialStyleRounded": "Afrundet (Rounded)",
	"iconPicker.materialStyleSharp": "Skarp (Sharp)",
	"iconPicker.materialWeight": "Ikontyngde",
	"iconPicker.materialWeight100": "Tynd (Thin)",
	"iconPicker.materialWeight200": "Ekstra let (Extra Light)",
	"iconPicker.materialWeight300": "Let (Light)",
	...
	"iconPicker.searchFa": "Søg i Font Awesome",
	"iconPicker.faStyle": "Ikonstil",
	"iconPicker.faStyleSolid": "Fyldt (Solid)",
	"iconPicker.faStyleRegular": "Almindelig (Regular)",
	...
	"iconPicker.descLucide": "Obsidians eget sæt, altid offline",
	"iconPicker.descTabler": "rene og konsistente UI-ikoner, kontur og fyldt",
	"iconPicker.descMaterial": "Googles sæt, fire stilarter og syv tykkelser",
	"iconPicker.descEmoji": "farverige glyffer, alle hudtoner",
	...
	"iconPicker.cat.Alert": "Advarsel",
	"iconPicker.cat.Alphabet": "Alfabet",
	"iconPicker.cat.Android": "Android",
	"iconPicker.cat.Animals": "Dyr",
	"iconPicker.cat.Arrows": "Pile",
	"iconPicker.cat.Astronomy": "Astronomi",
	"iconPicker.cat.Audio&Video": "Lyd og video",
	"iconPicker.cat.Automotive": "Biler",
	"iconPicker.cat.Badges": "Mærker",
	"iconPicker.cat.Brand": "Mærker",
	"iconPicker.cat.Buildings": "Bygninger",
	"iconPicker.cat.Business": "Erhverv",
	"iconPicker.cat.Camping": "Camping",
	"iconPicker.cat.Charity": "Velgørenhed",
	"iconPicker.cat.Charts": "Diagrammer",
	"iconPicker.cat.Charts + Diagrams": "Diagrammer og grafik",
	"iconPicker.cat.Childhood": "Barndom",
	"iconPicker.cat.Clothing + Fashion": "Tøj og mode",
	"iconPicker.cat.Coding": "Programmering",
	"iconPicker.cat.Communicate": "Kommuniker",
	"iconPicker.cat.Communication": "Kommunikation",
	"iconPicker.cat.Computers": "Computere",
	"iconPicker.cat.Connectivity": "Forbindelse",
	"iconPicker.cat.Construction": "Byggeri",
	"iconPicker.cat.Currencies": "Valutaer",
	"iconPicker.cat.Database": "Database",
	"iconPicker.cat.Design": "Design",
	"iconPicker.cat.Development": "Udvikling",
	"iconPicker.cat.Devices": "Enheder",
	"iconPicker.cat.Devices + Hardware": "Enheder og hardware",
	...
	"iconPicker.cat.Education": "Uddannelse",
	"iconPicker.cat.Electrical": "Elektrisk",
	"iconPicker.cat.Emoji": "Emoji",
	"iconPicker.cat.Energy": "Energi",
	"iconPicker.cat.Extensions": "Udvidelser",
	"iconPicker.cat.Files": "Filer",
	"iconPicker.cat.Film + Video": "Film og video",
	"iconPicker.cat.Food": "Mad",
	"iconPicker.cat.Food + Beverage": "Mad og drikke",
	"iconPicker.cat.Fruits + Vegetables": "Frugt og grønt",
	"iconPicker.cat.Games": "Spil",
	"iconPicker.cat.Gaming": "Gaming",
	"iconPicker.cat.Gender": "Køn",
	"iconPicker.cat.Genders": "Køn",
	"iconPicker.cat.Gestures": "Gester",
	"iconPicker.cat.Halloween": "Halloween",
	"iconPicker.cat.Hands": "Hænder",
	"iconPicker.cat.Hardware": "Hardware",
	"iconPicker.cat.Health": "Sundhed",
	"iconPicker.cat.Holidays": "Helligdage",
	"iconPicker.cat.Home": "Hjem",
	"iconPicker.cat.Household": "Husholdning",
	"iconPicker.cat.Humanitarian": "Humanitær",
	"iconPicker.cat.Images": "Billeder",
	"iconPicker.cat.Laundry": "Vask",
	"iconPicker.cat.Letters": "Bogstaver",
	"iconPicker.cat.Logic": "Logik",
	"iconPicker.cat.Logistics": "Logistik",
	"iconPicker.cat.Map": "Kort",
	"iconPicker.cat.Maps": "Kort",
	"iconPicker.cat.Maritime": "Søfart",
	...
	"iconPicker.cat.Media Playback": "Medieafspilning",
	"iconPicker.cat.Medical + Health": "Medicin og sundhed",
	"iconPicker.cat.Money": "Penge",
	"iconPicker.cat.Mood": "Humør",
	"iconPicker.cat.Moving": "Flytning",
	"iconPicker.cat.Music + Audio": "Musik og lyd",
	"iconPicker.cat.Nature": "Natur",
	"iconPicker.cat.Numbers": "Tal",
	"iconPicker.cat.Photography": "Fotografering",
	"iconPicker.cat.Photos + Images": "Fotos og billeder",
	"iconPicker.cat.Political": "Politisk",
	"iconPicker.cat.Privacy": "Privatliv",
	"iconPicker.cat.Punctuation + Symbols": "Tegnsætning og symboler",
	"iconPicker.cat.Religion": "Religion",
	"iconPicker.cat.Science": "Videnskab",
	"iconPicker.cat.Science Fiction": "Science fiction",
	"iconPicker.cat.Security": "Sikkerhed",
	"iconPicker.cat.Shapes": "Former",
	"iconPicker.cat.Shopping": "Shopping",
	"iconPicker.cat.Social": "Sociale medier",
	"iconPicker.cat.Spinners": "Spinnere",
	"iconPicker.cat.Sport": "Sport",
	"iconPicker.cat.Sports + Fitness": "Sport og fitness",
	...
	"iconPicker.cat.Toggle": "Skift",
	"iconPicker.cat.Transit": "Transit",
	"iconPicker.cat.Transportation": "Transport",
	"iconPicker.cat.Travel": "Rejse",
	"iconPicker.cat.Travel + Hotel": "Rejse og hotel",
	"iconPicker.cat.UI actions": "Grænseflade-handlinger",
	"iconPicker.cat.Users + People": "Brugere og mennesker",
	"iconPicker.cat.Vehicles": "Køretøjer",
	"iconPicker.cat.Version control": "Versionsstyring",
	"iconPicker.cat.Weather": "Vejr",
	"iconPicker.cat.Writing": "Skrivning",
	"iconPicker.cat.Zodiac": "Stjernetegn",

	// Downloadable icon packs
	"iconPack.downloadTitle": "{{name}} er endnu ikke downloadet",
	"iconPack.downloadDetail": "{{count}} ikoner · {{size}} · engangsdownload",
	"iconPack.download": "Download",
	"iconPack.downloading": "Downloader {{name}}…",
	"iconPack.downloadFailed":
		"Kunne ikke downloade {{name}}. Tjek din forbindelse og prøv igen.",
	...
	"settings.customizeMenuDesc":
		"Vælg hvilke højreklikhandlinger der vises for hver callout-type, og omarranger dem. Virker i kildetilstand og Live Preview.",
	...
	"vault.idsUpdated":
		"{{count}} callout-ID('er) opdateret i vault-filer: {{oldIds}} → {{newId}}",
	"vault.titlesUpdated":
		"{{count}} callout-titel(ler) opdateret i vault-filer: {{oldTitle}} → {{newTitle}}",
	...
	"vault.replacePromptInUse":
		'"{{name}}" bruges {{count}} gang(e) i {{files}} fil(er). Vælg en callout at erstatte den med:',
	"vault.replacePromptUnused": 'Vælg en callout til at erstatte "{{name}}":',
	"vault.noReplacementAvailable":
		"Ingen andre callouts tilgængelige som erstatning.",
	"vault.convertedToPlainText":
		"{{blocks}} callout-blok(ke) i {{files}} fil(er) konverteret til almindelig tekst.",
	...
	"quickInsert.sourceAria": "Filtrer efter callout-kilde",
	"quickInsert.sourceAll": "Alle",
	"quickInsert.sourceBuiltIn": "Indbygget",
	"quickInsert.sourceTheme": "Tema-callouts",
	"quickInsert.sourceUser": "Mine callouts",
	...
	"quickInsert.noBuiltInCallouts": "Der er i øjeblikket ingen indbyggede callouts tilgængelige.",
	"quickInsert.noThemeCallouts": "Der er i øjeblikket ingen temaspecifikke callouts tilgængelige.",
	...
	"portable.headingsTable": "Overskrifter",
	"portable.inlineTable": "Indlejrede",
	"portable.reviewTitle": "Konvertering fra Callout Studio",
	"portable.roleLink": "Link til overskrift",
	"portable.convertSelected": "Konverter valgte…",
	"portable.selectionSummary": "{{selected}} af {{total}} erstatninger valgt · {{links}} links til overskrifter skal opdateres",
	...
	"portable.openFailed": "Sidepanelet til konvertering kunne ikke åbnes.",
	"portable.closeSettings": "Luk indstillingerne for at gennemgå konverteringen i sidepanelet.",
	"portable.retry": "Prøv igen",
	"portable.blockedAmbiguous": "Denne overskrift springes over, fordi dens linkmål er tvetydigt.",
	"portable.blockedTarget": "Denne overskrift springes over, fordi dens linkmål ikke kan bevares sikkert.",
	"portable.recovery": "Der er stadig ændringer tilbage. Afslut denne konvertering og opdateringerne af links til overskrifter, før du genstarter eller deaktiverer pluginet; den ventende plan opbevares kun i hukommelsen.",
	"portable.recoveryChanged": "Noterne blev ændret, efter konverteringen stoppede. Ventende linkopdateringer bevares; hver note kontrolleres igen, før der skrives.",
	"portable.finishConversion": "Afslut konvertering…",
	"portable.recoveryUnavailable": "Nogle ventende linkopdateringer kunne ikke gendannes sikkert. Kontrollér de berørte noter, før du starter en ny konvertering.",
	"portable.title": "Konverter til standard-Markdown",
	"portable.settingDesc": "Erstat callouts i overskrifter og i teksten i hele boksen med almindelig tekst, klar til brug uden Callout Studio.",
	"portable.review": "Gennemgå konvertering",
	"portable.intro": "Hvis du vil stoppe med at bruge Callout Studio eller flytte din boks til en app uden det, kan du konvertere callouts i overskrifter og i teksten til standard-Markdown.",
	"portable.before": "Før",
	"portable.after": "Efter",
	"portable.word": "Ord",
	"portable.type": "type",
	"portable.text": "Tekst",
	"portable.headingText": "Titel",
	...
	"portable.convert": "Konverter boks…",
	...
	"portable.converting": "Konverterer de valgte ændringer… Konverteringen stopper ikke, hvis du lukker dette panel.",
	"portable.complete": "Konverterede {{count}} forekomster og opdaterede {{links}} links til overskrifter i {{files}} noter.",
	"portable.stopped": "Konverteringen stoppede. {{count}} forekomster og {{links}} links til overskrifter i {{files}} noter var allerede ændret; ændringerne bevares.",
	"portable.errorEditor": "Gem åbne noter for at opdatere gennemgangen automatisk.",
	...
	"portable.editCustom": "Rediger tilpasset erstatning…",
	"portable.restoreDefault": "Gendan standarderstatning",
	"portable.customTitle": "Tilpasset erstatning",
	"portable.customSave": "Gem erstatning",
	"portable.customInvalid": "Hold erstatningen på én linje uden at ændre den omgivende Markdown-struktur.",
	"portable.customUnsafe": "Denne erstatning ville gøre en overskrift eller dens links tvetydige. Vælg en anden overskrift.",
	"portable.customStale": "Gennemgangen er ændret. Luk dette vindue, og åbn erstatningseditoren igen.",
	"portable.customDiscarded": "{{count}} tilpassede erstatninger blev fjernet, fordi deres kildetekst blev ændret eller ikke kunne findes med sikkerhed.",
	"portable.customBadge": "Tilpasset",

	"usage.title": "Forekomster af Callout Studio",
	...
	"usage.partial": "Resultaterne er ufuldstændige: {{count}} læsefejl.",
	"usage.stale": "Opdaterer forekomster af callouts…",
	"usage.empty": "Ingen matchende callouts fundet.",
	"usage.failedFiles": "Filer, der ikke kunne læses",
	"usage.vaultReadFailed": "Markdown-noterne i denne vault kunne ikke listes.",
	"usage.more": "Vis {{count}} flere",
	"usage.location": "Linje {{line}} · {{role}}",
	...
	"import.warn.settingsIgnored":
		"Indstillingsblokken var ikke et gyldigt objekt og blev ignoreret.",
	...
	"import.err.boolField":
		'"{{field}}" skal være en boolean (true eller false).',
	"import.err.iconNotObject": "Ikonet skal være et objekt.",
	"import.err.iconTypeInvalid":
		'Ikontypen "{{value}}" er ikke én af: {{types}}.',
	...
	"import.err.materialWeight":
		'Material-ikonvægten "{{value}}" skal være et heltal mellem 100 og 700 i trin af 100.',
	"import.warn.iconRecolorIgnored":
		'"recolor" gælder kun for egne billeder og ignoreres for ikontype {{type}}.',
	"import.err.iconRecolorInvalid":
		'"recolor" skal være true eller false (fik "{{value}}").',
	"import.err.colorInvalid":
		'"{{field}}" skal være en hex-farve som "#448aff" (modtog "{{value}}").',
	...
	"import.err.aliasConflict":
		'Alias "{{value}}" bruges allerede af en anden callout ("{{other}}") i din vault.',
	...
	"import.admInstructions":
		...
		"farve. Indstillinger uden en modsvarighed i Callout Studio " +
		"(kommando, kopiknap, skjult titel) følger ikke med.",
	...
	"import.err.admNotRecognized":
		"Filen blev ikke genkendt: der forventedes en liste over " +
		"admonitions eller en data.json fra Admonition.",
	"import.err.admNoEntries":
		"Der blev ikke fundet nogen admonitions at importere.",
	...
	"import.warn.admIconWithCss":
		...
		"navn, ikon og farve kom med.",
	"import.warn.admNoColor":
		"Der var ingen farve angivet, så standardblå blev brugt.",
	"import.warn.admTitleTruncated":
		"Titlen er på {{length}} tegn; den blev forkortet til {{max}}.",

	"footer.prompt":
		"Spørgsmål, fejl eller idéer? Jeg vil meget gerne høre fra dig!{{break}} {{issue}} eller {{email}}.",
	"footer.openIssue": "Opret en GitHub-issue",
	"footer.sendEmail": "send mig en e-mail",
	"footer.sourceCode": "Kildekode",
	...
	"locale.downloading": "Downloader oversættelse…",
	"locale.notDownloaded": "{{name}} er ikke downloadet endnu",
	"locale.notDownloadedDesc":
		"Callout Studio viser engelsk, indtil oversættelsen kan downloades. Der forsøges igen, næste gang Obsidian starter.",
	"locale.retry": "Prøv igen",
	"locale.diskWriteFailed":
		"Callout Studio kunne ikke gemme oversættelsen på disken, så den skal downloades igen næste gang.",
	"notice.exportedCssCreated": "CSS-udsnit gemt i {{path}}",
	"notice.exportedCssUpdated": "CSS-udsnit opdateret i {{path}}",
	"notice.exportedCssUnchanged": "CSS-udsnittet er allerede opdateret.",
	"notice.exportCssEmpty":
		"Der er ingen brugerdefinerede callouts at eksportere.",
	"notice.exportCssFailed":
		"CSS-udsnittet kunne ikke gemmes. Se udviklerkonsollen for detaljer.",
	"notice.exportCssEnabled":
		"Dette udsnit er slået til i denne vault. Callout Studio styler allerede disse callouts, og udsnittet bevarer stilen fra eksporttidspunktet.",
	"confirm.titleOverwriteSnippet": "Overskriv CSS-udsnit",
