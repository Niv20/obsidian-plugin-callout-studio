export const uk: Record<string, string> = {
	"portable.headingsTable": "Заголовки",
	"portable.inlineTable": "У тексті",
	"portable.reviewTitle": "Перетворення Callout Studio",
	"portable.roleLink": "Посилання на заголовок",
	"portable.convertSelected": "Перетворити вибране…",
	"portable.selectionSummary": "Вибрано {{selected}} із {{total}} замін · Посилань на заголовки для оновлення: {{links}}",
	...
	"portable.openFailed": "Не вдалося відкрити бічну панель перетворення.",
	"portable.closeSettings": "Закрийте налаштування, щоб перевірити перетворення в бічній панелі.",
	"portable.retry": "Спробувати ще раз",
	"portable.blockedAmbiguous": "Цей заголовок пропущено, оскільки ціль посилання неоднозначна.",
	"portable.blockedTarget": "Цей заголовок пропущено, оскільки ціль посилання неможливо безпечно зберегти.",
	"portable.recovery": "Залишилися незастосовані зміни. Завершіть перетворення та оновлення посилань на заголовки перед перезапуском або вимкненням плагіна: план решти змін зберігається лише в пам’яті.",
	"portable.recoveryChanged": "Нотатки змінилися після зупинки перетворення. Очікувані оновлення посилань збережено; перед записом кожну нотатку буде перевірено знову.",
	"portable.finishConversion": "Завершити перетворення…",
	"portable.recoveryUnavailable": "Деякі очікувані оновлення посилань не вдалося безпечно відновити. Перевірте відповідні нотатки перед новим перетворенням.",
	"portable.title": "Перетворити на стандартний Markdown",
	"portable.settingDesc": "Замініть callout у заголовках і тексті в усьому сховищі звичайним текстом, придатним для використання без Callout Studio.",
	"portable.review": "Перевірити перетворення",
	"portable.intro": "Якщо ви плануєте відмовитися від Callout Studio або перенести сховище до застосунку без його підтримки, перетворіть callout у заголовках і тексті на стандартний Markdown.",
	"portable.before": "До",
	"portable.after": "Після",
	"portable.word": "Слово",
	"portable.type": "тип",
	"portable.text": "Текст",
	"portable.headingText": "Заголовок",
	...
	"portable.convert": "Перетворити сховище…",
	...
	"portable.converting": "Перетворення вибраних змін… Закриття цієї панелі не зупинить перетворення.",
	"portable.complete": "Перетворено входжень: {{count}}; оновлено посилань на заголовки: {{links}} у {{files}} нотатках.",
	"portable.stopped": "Перетворення зупинено. Уже змінено входжень: {{count}} і посилань на заголовки: {{links}} у {{files}} нотатках; ці зміни збережено.",
	"portable.errorEditor": "Збережіть відкриті нотатки, щоб попередній перегляд оновився автоматично.",
	...
	"notice.settingsMissingAction": "Створити новий файл налаштувань",
	...
	"editor.replaceIcon": "Замінити значок",
	"editor.removeIcon": "Видалити значок",
	"editor.noIcon": "Без значка",
	...
	"palette.darkMode": "Темний",
	"palette.accentColor": "Акцентний колір",
	"palette.backgroundColorChannel": "Колір фону",
	"palette.textColorChannel": "Колір тексту",
	...
	"colorName.crimson": "Малиновий",
	"colorName.coral": "Кораловий",
	"colorName.grape": "Виноградний",
	"colorName.plum": "Сливовий",
	"colorName.bubblegum": "Жувальна гумка",
	...
	"iconPicker.searchTabler": "пошук іконок Tabler",
	"iconPicker.tablerStyle": "Стиль іконки",
	"iconPicker.tablerStyleOutline": "Контур",
	"iconPicker.tablerStyleFilled": "Заповнений",
	"iconPicker.loadMore": "Завантажити ще",
	"iconPicker.materialStyle": "Стиль іконки",
	"iconPicker.materialStyleOutlined": "Контурний (Outlined)",
	"iconPicker.materialStyleFilled": "Заповнений (Filled)",
	"iconPicker.materialStyleRounded": "Заокруглений (Rounded)",
	"iconPicker.materialStyleSharp": "Гострий (Sharp)",
	"iconPicker.materialWeight": "Товщина іконки",
	"iconPicker.materialWeight100": "Тонкий (Thin)",
	"iconPicker.materialWeight200": "Дуже легкий (Extra Light)",
	"iconPicker.materialWeight300": "Легкий (Light)",
	"iconPicker.materialWeight400": "Звичайний (Regular)",
	...
	"iconPicker.searchFa": "Пошук в Font Awesome",
	"iconPicker.faStyle": "Стиль іконки",
	"iconPicker.faStyleSolid": "Заповнений",
	"iconPicker.faStyleRegular": "Звичайний",
	...
	"iconPicker.cat.Actions": "Дії",
	"iconPicker.cat.Activities": "Заняття",
	"iconPicker.cat.Alert": "Попередження",
	"iconPicker.cat.Alphabet": "Алфавіт",
	"iconPicker.cat.Android": "Android",
	"iconPicker.cat.Animals": "Тварини",
	"iconPicker.cat.Arrows": "Стрілки",
	"iconPicker.cat.Astronomy": "Астрономія",
	"iconPicker.cat.Audio&Video": "Аудіо та відео",
	"iconPicker.cat.Automotive": "Автомобілі",
	"iconPicker.cat.Badges": "Значки",
	"iconPicker.cat.Brand": "Бренд",
	"iconPicker.cat.Buildings": "Будівлі",
	"iconPicker.cat.Business": "Бізнес",
	"iconPicker.cat.Camping": "Кемпінг",
	"iconPicker.cat.Charity": "Благодійність",
	"iconPicker.cat.Charts": "Діаграми",
	"iconPicker.cat.Charts + Diagrams": "Діаграми та схеми",
	"iconPicker.cat.Childhood": "Дитинство",
	"iconPicker.cat.Clothing + Fashion": "Одяг і мода",
	"iconPicker.cat.Coding": "Програмування",
	"iconPicker.cat.Communicate": "Спілкування",
	"iconPicker.cat.Communication": "Комунікації",
	"iconPicker.cat.Computers": "Комп'ютери",
	"iconPicker.cat.Connectivity": "З'єднання",
	"iconPicker.cat.Construction": "Будівництво",
	"iconPicker.cat.Currencies": "Валюти",
	"iconPicker.cat.Database": "База даних",
	"iconPicker.cat.Design": "Дизайн",
	"iconPicker.cat.Development": "Розробка",
	"iconPicker.cat.Devices": "Пристрої",
	"iconPicker.cat.Devices + Hardware": "Пристрої та обладнання",
	"iconPicker.cat.Disaster + Crisis": "Катастрофи та кризи",
	"iconPicker.cat.Document": "Документ",
	"iconPicker.cat.E-commerce": "Електронна комерція",
	"iconPicker.cat.Editing": "Редагування",
	"iconPicker.cat.Education": "Освіта",
	"iconPicker.cat.Electrical": "Електрика",
	"iconPicker.cat.Emoji": "Емодзі",
	"iconPicker.cat.Energy": "Енергія",
	"iconPicker.cat.Extensions": "Розширення",
	"iconPicker.cat.Files": "Файли",
	"iconPicker.cat.Film + Video": "Кіно та відео",
	"iconPicker.cat.Food": "Їжа",
	"iconPicker.cat.Food + Beverage": "Їжа та напої",
	"iconPicker.cat.Fruits + Vegetables": "Фрукти та овочі",
	"iconPicker.cat.Games": "Ігри",
	"iconPicker.cat.Gaming": "Гейминг",
	"iconPicker.cat.Gender": "Стать",
	"iconPicker.cat.Genders": "Гендери",
	"iconPicker.cat.Gestures": "Жести",
	"iconPicker.cat.Halloween": "Гелловін",
	"iconPicker.cat.Hands": "Руки",
	"iconPicker.cat.Hardware": "Обладнання",
	"iconPicker.cat.Health": "Здоров'я",
	"iconPicker.cat.Holidays": "Свята",
	"iconPicker.cat.Home": "Дім",
	"iconPicker.cat.Household": "Побут",
	"iconPicker.cat.Humanitarian": "Гуманітарний",
	"iconPicker.cat.Images": "Зображення",
	"iconPicker.cat.Laundry": "Прання",
	"iconPicker.cat.Letters": "Літери",
	"iconPicker.cat.Logic": "Логіка",
	"iconPicker.cat.Logistics": "Логістика",
	"iconPicker.cat.Map": "Карта",
	"iconPicker.cat.Maps": "Карти",
	"iconPicker.cat.Maritime": "Морський",
	"iconPicker.cat.Marketing": "Маркетинг",
	"iconPicker.cat.Math": "Математика",
	"iconPicker.cat.Mathematics": "Математика",
	"iconPicker.cat.Media": "Медіа",
	"iconPicker.cat.Media Playback": "Відтворення медіа",
	"iconPicker.cat.Medical + Health": "Медицина та здоров'я",
	"iconPicker.cat.Money": "Гроші",
	"iconPicker.cat.Mood": "Настрій",
	"iconPicker.cat.Moving": "Переїзд",
	"iconPicker.cat.Music + Audio": "Музика та звук",
	"iconPicker.cat.Nature": "Природа",
	"iconPicker.cat.Numbers": "Числа",
	"iconPicker.cat.Photography": "Фотографія",
	"iconPicker.cat.Photos + Images": "Фотографії та зображення",
	"iconPicker.cat.Political": "Політика",
	"iconPicker.cat.Privacy": "Конфіденційність",
	"iconPicker.cat.Punctuation + Symbols": "Пунктуація та символи",
	"iconPicker.cat.Religion": "Релігія",
	"iconPicker.cat.Science": "Наука",
	"iconPicker.cat.Science Fiction": "Наукова фантастика",
	"iconPicker.cat.Security": "Безпека",
	"iconPicker.cat.Shapes": "Фігури",
	"iconPicker.cat.Shopping": "Покупки",
	"iconPicker.cat.Social": "Соціальні мережі",
	"iconPicker.cat.Spinners": "Спінери",
	"iconPicker.cat.Sport": "Спорт",
	"iconPicker.cat.Sports + Fitness": "Спорт і фітнес",
	"iconPicker.cat.Symbols": "Символи",
	"iconPicker.cat.System": "Система",
	"iconPicker.cat.Text": "Текст",
	"iconPicker.cat.Text Formatting": "Форматування тексту",
	"iconPicker.cat.Time": "Час",
	"iconPicker.cat.Toggle": "Перемикач",
	"iconPicker.cat.Transit": "Транзит",
	"iconPicker.cat.Transportation": "Транспорт",
	"iconPicker.cat.Travel": "Подорожі",
	"iconPicker.cat.Travel + Hotel": "Подорожі та готелі",
	"iconPicker.cat.UI actions": "Дії інтерфейсу",
	"iconPicker.cat.Users + People": "Користувачі та люди",
	"iconPicker.cat.Vehicles": "Транспортні засоби",
	"iconPicker.cat.Version control": "Контроль версій",
	"iconPicker.cat.Weather": "Погода",
	"iconPicker.cat.Writing": "Письмо",
	"iconPicker.cat.Zodiac": "Зодіак",
	...
	"portable.restoreDefault": "Відновити стандартну заміну",
	"portable.customTitle": "Власна заміна",
	"portable.customSave": "Зберегти заміну",
	"portable.customInvalid": "Залиште заміну в одному рядку, не змінюючи навколишню структуру Markdown.",
	"portable.customUnsafe": "Ця заміна зробить заголовок або посилання на нього неоднозначними. Виберіть інший заголовок.",
	"portable.customStale": "Попередній перегляд змінився. Закрийте це вікно й знову відкрийте редактор заміни.",
	"portable.customDiscarded": "Вилучено {{count}} власних замін, оскільки їхній вихідний текст змінився або його не вдалося надійно знайти.",
	"portable.customBadge": "Власна",

	"usage.title": "Входження Callout Studio",
	...
	"import.err.idReserved":
		"ID «{{value}}» зарезервовано Callout Studio для власних попередніх переглядів, тому його не можна імпортувати.",
	...
	"locale.downloading": "Завантаження перекладу…",
	"locale.notDownloaded": "{{name}} ще не завантажено",
	"locale.notDownloadedDesc":
		"Callout Studio показує англійську, доки переклад не буде завантажено. Наступного запуску Obsidian буде повторна спроба.",
	"locale.retry": "Повторити",
	"locale.diskWriteFailed":
		"Callout Studio не вдалося зберегти переклад на диск, тому наступного разу його потрібно буде завантажити знову.",
	"notice.exportedCssCreated": "Фрагмент CSS збережено в {{path}}",
	"notice.exportedCssUpdated": "Фрагмент CSS оновлено в {{path}}",
	"notice.exportedCssUnchanged": "Фрагмент CSS уже актуальний.",
	"notice.exportCssEmpty": "Немає користувацьких callout для експорту.",
	"notice.exportCssFailed":
		"Не вдалося зберегти фрагмент CSS. Докладніше дивіться в консолі розробника.",
	"notice.exportCssEnabled":
		"Цей фрагмент увімкнено в цьому vault. Callout Studio уже стилізує ці callout, а фрагмент зберігає стиль на момент експорту.",
	"confirm.titleOverwriteSnippet": "Перезаписати фрагмент CSS",
	...
	"confirm.startFreshOk": "Створити новий файл налаштувань",
	"confirm.titleRestoreSettings": "Відновити ці налаштування",
	"confirm.titleCreateSettingsFile": "Створити файл налаштувань",
	"confirm.restoreDisplayedSettings": "Це збереже типи callout і параметри, які зараз показані, у файл налаштувань на цьому пристрої та відновить збереження. Кожна читабельна локальна копія відновлення спочатку буде зарезервована.\nПерш ніж продовжити, дочекайтеся завершення роботи служби синхронізації та перевірте, чи немає на іншому пристрої новіших налаштувань, які ви хочете зберегти. Ваша служба синхронізації може надіслати цей відновлений файл на інші ваші пристрої.\nПеред збереженням файл буде перевірено ще раз. Якщо знайдено наявні налаштування, їх буде збережено, а відновлення може попросити перевірити ще раз.",
	"confirm.titleStartFresh": "Створити новий файл налаштувань",
	...
	"saveStatus.changed": "Файл налаштувань змінився, поки ви редагували. Ваш чернетковий варіант усе ще доступний. Виберіть Повторити збереження та відновлення, щоб завантажити вхідні налаштування, потім перегляньте чернетку та збережіть знову.",
	...
	"saveStatus.newFile": "Створити новий файл налаштувань",
	"saveStatus.restoreSettings": "Відновити ці налаштування",
	"saveStatus.createSettingsFile": "Створити файл налаштувань",
	"saveStatus.checkAgain": "Перевірити ще раз",
	"saveStatus.stillMissing": "Файл налаштувань досі відсутній. Повторна перевірка не створює його заново. Дочекайтеся завершення синхронізації та зробіть сховище доступним офлайн. Якщо файл було видалено, відновіть резервну копію або скористайтеся дією відновлення в налаштуваннях Callout Studio на цьому пристрої, щоб зберегти показані налаштування.",
	"saveStatus.recoverInSettings": "Щоб відновити відсутній файл на цьому пристрої, відкрийте налаштування Callout Studio. Перед закриттям цього редактора скопіюйте всі незбережені зміни, які хочете зберегти; їх не було збережено.",
	"saveStatus.openSettings": "Відкрити налаштування Callout Studio",
	"notice.openSettingsFailed": "Не вдалося відкрити налаштування Callout Studio. Відкрийте Налаштування → Callout Studio, щоб вибрати, що робити.",
	"saveStatus.notesFailed": "Визначення callout збережено, але деякі оновлення нотаток не вдалося завершити. Залиште цей редактор відкритим і виберіть Зберегти, щоб повторити незавершені оновлення.",
	"saveStatus.recoveryRead": "Збереження призупинено, оскільки не вдається прочитати локальну копію відновлення. Ваш файл налаштувань, можливо, усе ще цілий. Перевірте вільне місце на диску, потім повторіть відновлення. Наявні дані відновлення не буде перезаписано.",
	"saveStatus.recoveryWrite": "Не вдалося зберегти локальну копію відновлення. Перевірте вільне місце на диску, потім повторіть спробу. Залиште чернетку відкритою, доки збереження не вдасться.",
	"saveStatus.retry": "Повторити збереження та відновлення",
	"saveStatus.retryFailed": "Збереження досі заблоковано. Перевірте статус збереження в налаштуваннях Callout Studio, щоб дізнатися причину, потім повторіть спробу.",
	"saveStatus.retrying": "Перевірка збереження та відновлення…",
	"saveStatus.reviewDraft": "Вхідні налаштування та перевірки відновлення завершено. Ваша чернетка не змінена. Перегляньте її та збережіть знову.",
	"saveStatus.settingsArrived": "Наявні налаштування прибули та були завантажені. Файл заміни не створено.",
	"saveStatus.syncConflict": "Вхідні налаштування конфліктують із callout, потрібним для незавершених оновлень нотаток. Вашу чернетку та незавершені оновлення збережено. Розв'яжіть конфлікт налаштувань, перш ніж повторити спробу.",
	"saveStatus.titlePaused": "Збереження призупинено",
	"saveStatus.titleFailed": "Налаштування не збережено",
	"saveStatus.unreadable": "Збереження призупинено, оскільки файл налаштувань неможливо безпечно прочитати. Завершіть синхронізацію або відновіть дійсну копію, потім повторіть спробу. Наявний файл збережено.",
	"saveStatus.write": "Не вдалося зберегти файл налаштувань. Перевірте вільне місце на диску, права папки та синхронізацію, потім повторіть спробу перед закриттям Obsidian.",
	"saveStatus.writePermission": "Не вдалося зберегти файл налаштувань, оскільки в доступі на запис було відмовлено. Перевірте, що сховище та папка плагіна доступні для запису, потім повторіть спробу.",
	"saveStatus.writeSpace": "Не вдалося зберегти файл налаштувань, оскільки місця на диску немає або квоту перевищено. Звільніть трохи місця, потім повторіть спробу.",
	"settings.readOnly": "Callout Studio не зміг використати свій файл налаштувань під час запуску Obsidian, тому на цій сторінці нічого не зберігається на цьому пристрої. Ваші зміни залишатимуться, доки ви не закриєте Obsidian. Перезавантажте Obsidian, щойно файл повернеться — якщо ви синхронізуєте це сховище, спочатку дайте синхронізації завершитися.",
};
