export const hu: Record<string, string> = {
	...
	"settings.maintenance": "Karbantartás",
	...
	"usage.title": "Callout-előfordulások",
	"usage.selectType": "Callout-típus",
	...
	"usage.markdownFiles": "Markdown-fájlok",
	"usage.filterRole": "Szűrés formátum szerint",
