export const cs: Record<string, string> = {
	...
	"settings.rescanVaultDesc": "Přidá typy calloutů nalezené ve vašich poznámkách, které zatím nejsou v tomto seznamu. Stávající callouty a poznámky zůstanou beze změny.",
