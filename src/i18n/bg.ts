export const bg: Record<string, string> = {
	...
	"settings.maintenance": "Поддръжка",
	...
	"usage.title": "Срещания на callout-и",
	...
	"usage.markdownFiles": "Markdown файлове",
	"usage.filterRole": "Филтриране по формат",
	...
	"usage.menuCount": "Търсене на употреби: {{count}} в {{files}} файла",
