export const zhTW: Record<string, string> = {
	"portable.headingsTable": "標題",
	"portable.inlineTable": "行內",
	"portable.reviewTitle": "Callout Studio 轉換",
	"portable.roleLink": "標題連結",
	"portable.convertSelected": "轉換所選內容…",
	"portable.selectionSummary": "已選取 {{selected}} / {{total}} 項取代 · {{links}} 個標題連結待更新",
	...
	"portable.openFailed": "無法開啟轉換側邊欄。",
	"portable.closeSettings": "請關閉設定，在側邊欄中檢查轉換內容。",
	"portable.retry": "重試",
	"portable.blockedAmbiguous": "此標題的連結目標不明確，因此已略過。",
	"portable.blockedTarget": "無法安全保留此標題的連結目標，因此已略過。",
	"portable.recovery": "仍有變更待處理。請在重新啟動或停用外掛前完成這次轉換及標題連結更新；待處理計畫僅保存在記憶體中。",
	"portable.recoveryChanged": "轉換停止後，筆記發生了變更。待更新的連結已保留；寫入前會重新檢查每篇筆記。",
	"portable.finishConversion": "完成轉換…",
	"portable.recoveryUnavailable": "無法安全復原部分待處理的連結更新。請先檢查受影響的筆記，再開始新的轉換。",
	"portable.title": "轉換為標準 Markdown",
	"portable.settingDesc": "將整個儲存庫中的標題與行內 callout 替換為一般文字，方便在沒有 Callout Studio 的環境中使用。",
	"portable.review": "檢查轉換內容",
	"portable.intro": "如果您打算停止使用 Callout Studio，或將儲存庫移至不支援它的應用程式，可以將標題與行內 callout 轉換為標準 Markdown。",
	"portable.before": "轉換前",
	"portable.after": "轉換後",
	"portable.word": "文字",
	"portable.type": "類型",
	"portable.text": "文字內容",
	"portable.headingText": "標題",
	"portable.backup": "建議在轉換前備份儲存庫。此操作會修改原始筆記，且無法在 Callout Studio 中復原。",
	"portable.convert": "轉換儲存庫…",
	...
	"portable.converting": "正在轉換所選內容… 關閉此面板不會停止轉換。",
	"portable.complete": "已轉換 {{files}} 篇筆記中的 {{count}} 處內容，並更新 {{links}} 個標題連結。",
	"portable.stopped": "轉換已停止。{{files}} 篇筆記中的 {{count}} 處內容與 {{links}} 個標題連結已變更；這些變更會保留。",
	"portable.errorEditor": "儲存已開啟的筆記，即可自動更新預覽。",
	"portable.errorChanged": "筆記已變更。請在轉換前檢查更新後的內容。",
	"portable.errorBusy": "另一項轉換正在進行。請等待它完成。",
	"portable.error": "無法安全讀取或更新儲存庫。請檢查檔案存取權限後重試。",
	"settings.maintenance": "危險區域",
	...
	"importBanner.message":
		"我們注意到您正在使用 {{plugins}}。是否要匯入您的 callout？",
	"importBanner.action": "匯入",
	...
	"menuItem.createOrEdit": "建立或編輯 callout",
	...
	"portable.restoreDefault": "還原預設取代",
	"portable.customTitle": "自訂取代",
	"portable.customSave": "儲存取代",
	"portable.customInvalid": "請將取代內容保留在一行內，不要更改周圍的 Markdown 結構。",
	"portable.customUnsafe": "此取代會導致標題或其連結的目標不明確。請選擇其他標題。",
	"portable.customStale": "預覽已變更。請關閉此視窗，然後重新開啟取代編輯器。",
	"portable.customDiscarded": "已清除 {{count}} 個自訂取代，因為其原始文字已變更或無法安全定位。",
	"portable.customBadge": "自訂",

	"usage.title": "Callout Studio 出現位置",
	"usage.command": "Callout 出現位置",
	"usage.subtitle": "尋找保管庫中的 Callout，並跳至其原始位置。",
	"usage.browse": "瀏覽",
	"usage.allTypes": "所有類型",
	...
	"usage.partial": "結果不完整：有 {{count}} 處讀取錯誤。",
	"usage.stale": "正在更新 Callout 出現位置…",
	"usage.empty": "找不到相符的 Callout。",
	"usage.failedFiles": "無法讀取的檔案",
	"usage.vaultReadFailed": "無法列出此 Vault 中的 Markdown 筆記。",
	"usage.more": "再顯示 {{count}} 個",
	...
	"editor.colorsDescDeleted":
		"此 callout 的已儲存色彩已被刪除。{{link}}",
	"editor.colorsDescDeletedLink": "還原",
	"palette.colorExists":
	...
	"notice.legacyDiscoveryArchiveFailed": "升級復原副本未能完成。先前的本機探索快取與啟動 CSS 已原樣保留。請檢查儲存空間的寫入權限與可用空間，然後重新啟動 Obsidian 以重試。",
	...
	"confirm.titleRestoreSettings": "復原這些設定",
	"confirm.titleCreateSettingsFile": "建立設定檔",
	"confirm.restoreDisplayedSettings": "這會將目前顯示的 callout 類型和偏好設定儲存到此裝置上的設定檔，並恢復儲存。任何可讀取的本機復原副本都會先備份。\n繼續之前，請等待同步服務完成，並檢查其他裝置上是否有你想保留的較新設定。同步服務可能會將這個復原的檔案傳送到你的其他裝置。\n儲存前會再次檢查檔案。如果找到現有設定，將保留它們，復原流程可能會要求你再次檢查。",
	...
	"saveStatus.createSettingsFile": "建立設定檔",
	"saveStatus.checkAgain": "再次檢查",
	"saveStatus.stillMissing": "設定檔仍然遺失。再次檢查不會重新建立它。請等待同步完成，並讓庫可離線使用。如果檔案已被刪除，請還原備份，或在此裝置的 Callout Studio 設定中使用復原動作來儲存目前顯示的設定。",
	"saveStatus.recoverInSettings": "若要在此裝置上復原遺失的檔案，請開啟 Callout Studio 設定。關閉此編輯器前，請複製你想保留的所有未儲存編輯；它們尚未儲存。",
