export const fa: Record<string, string> = {
	...
	"settings.unlinkedColors": "رنگ‌های بدون پیوند",
	"settings.unlinkedColorsDesc":
		"کال‌اوت‌هایی که رنگ ذخیره‌شده‌شان حذف شده است. رنگ فعلی را نگه می‌دارند؛ بازیابی دوباره رنگ را ذخیره می‌کند و کل گروه را دوباره پیوند می‌دهد.",
	"settings.unlinkedColorOne": "۱ کال‌اوت",
	"settings.unlinkedColorCount": "{{count}} کال‌اوت",
	"settings.restoreColor": "بازیابی",
	"settings.palettesMergedNotice":
		"{{count}} پالت واردشده با رنگ‌های ذخیره‌شده‌ای که از قبل همان رنگ‌ها را داشتند ادغام شد.",
	...
	"editor.colorsDescDeleted":
		"رنگ ذخیره‌شدهٔ این کال‌اوت حذف شده است. می‌توانید با {{link}} دوباره آن را ذخیره کنید.",
	"editor.colorsDescDeletedOther":
		"رنگ ذخیره‌شدهٔ این کال‌اوت حذف شده است. می‌توانید با {{link}} دوباره آن را ذخیره کنید — ۱ کال‌اوت دیگر که از آن استفاده می‌کند هم دوباره متصل می‌شود.",
	"editor.colorsDescDeletedOthers":
		"رنگ ذخیره‌شدهٔ این کال‌اوت حذف شده است. می‌توانید با {{link}} دوباره آن را ذخیره کنید — {{count}} کال‌اوت دیگر که از آن استفاده می‌کنند هم دوباره متصل می‌شوند.",
	"editor.colorsDescDeletedLink": "اینجا کلیک کردن",
	"palette.colorExists":
