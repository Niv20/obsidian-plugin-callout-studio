export const th: Record<string, string> = {
	...
	"settings.maintenance": "การบำรุงรักษา",
	...
	"usage.title": "ตำแหน่งที่พบ callout",
	"usage.selectType": "ประเภท callout",
	...
	"usage.markdownFiles": "ไฟล์ Markdown",
	"usage.filterRole": "กรองตามรูปแบบ",
