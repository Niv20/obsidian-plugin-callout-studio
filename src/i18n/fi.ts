export const fi: Record<string, string> = {
	...
	"usage.title": "Callout-esiintymät",
	"usage.selectType": "Callout-tyyppi",
	"usage.browse": "Selaa",
	...
	"usage.markdownFiles": "Markdown-tiedostot",
	"usage.filterRole": "Suodata muodon mukaan",
