export const el: Record<string, string> = {
	...
	"settings.maintenance": "Συντήρηση",
	...
	"usage.title": "Εμφανίσεις callout",
	"usage.selectType": "Τύπος callout",
	...
	"usage.markdownFiles": "Αρχεία Markdown",
	"usage.filterRole": "Φιλτράρισμα κατά μορφή",
	...
	"usage.menuCount": "Εύρεση χρήσεων: {{count}} σε {{files}} αρχεία",
