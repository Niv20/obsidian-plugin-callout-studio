export const ms: Record<string, string> = {
	...
	"settings.maintenance": "Penyelenggaraan",
	...
	"usage.title": "Kemunculan callout",
	"usage.selectType": "Jenis callout",
	"usage.browse": "Teroka",
	...
	"usage.markdownFiles": "Fail Markdown",
	"usage.filterRole": "Tapis mengikut format",
