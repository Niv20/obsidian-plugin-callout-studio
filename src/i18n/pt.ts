export const pt: Record<string, string> = {
	...
	"usage.title": "Ocorrências de callouts",
	"usage.selectType": "Tipo de callout",
	...
	"usage.markdownFiles": "Arquivos Markdown",
	"usage.filterRole": "Filtrar por formato",
	...
	"usage.menuCount": "Encontrar usos: {{count}} em {{files}} arquivos",
