export const ro: Record<string, string> = {
	...
	"settings.maintenance": "Întreținere",
	...
	"usage.title": "Apariții ale callout-urilor",
	"usage.selectType": "Tip de callout",
	...
	"usage.markdownFiles": "Fișiere Markdown",
	"usage.filterRole": "Filtrează după format",
